...
const analysis = (weeks: number): HorizonAnalysis => ({ weeks, targetDate: '2026-07-24', sampleSize: 500, effectiveSampleSize: 500, lower: [risk], upper: [risk], empirical: { closeLowPct: -0.2, closeHighPct: 0.2, pathLowPct: -0.3, pathHighPct: 0.3, closeMinPct: -0.5, closeMaxPct: 0.5, pathMinPct: -0.6, pathMaxPct: 0.6 }, bootstrap: { closeLowPct: [-0.25, -0.15], closeHighPct: [0.15, 0.25], pathLowPct: [-0.35, -0.25], pathHighPct: [0.25, 0.35] }, evt: { note: 'stress', lowerDiagnostics: 'unavailable', upperDiagnostics: 'unavailable' } })
